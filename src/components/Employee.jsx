...
const Employee = ({ employee }) => {
  ...
  return (
    <>
      <div className={alertmsg === true ? "block" : "hidden"}>
        <div
          id="alert-4"
          className="flex mt-2 items-center p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300"
          role="alert"
        >
          <svg
